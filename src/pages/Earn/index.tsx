    ...
    <PageWrapper gap="lg" justify="center">
      <TopSection gap="md">
        <DataCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Puffyswap Farming</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Deposit your Liquidity Provider tokens to receive PUFFY, the Puffyswap protocol governance token.
                </TYPE.white>
                
              </RowBetween>{' '}
              <RowBetween>
              <ExternalLink id={`old-pools-link`} href={''} style={{width: isMobile?'50%':'25%'}}>
      ...
      <AutoColumn gap="lg" style={{ width: '100%', maxWidth: '720px' }}>
        ...
        <RowBetween style={{marginTop: "10px"}}>
          ...
          <TYPE.white>
            {totalRewards.toFixed(0)} PUFFY / day
          </TYPE.white>
        </RowBetween>
        <RowBetween style={{marginTop: "10px"}}>
