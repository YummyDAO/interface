...
function Web3StatusInner() {
  ...
  if (account) {
    ...
    return (
      <Web3StatusConnect id="connect-wallet" onClick={(ethereum && ethereum.isMetaMask && Number(ethereum.chainId) !== 10001) ?addMaticToMetamask:toggleWalletModal} faded={!account}>
        <Text>{(ethereum && ethereum.isMetaMask && Number(ethereum.chainId) !== 10001) ? t('Switch to Matic'): t('Connect to a wallet')}</Text>
      </Web3StatusConnect>
    )
  }
}
